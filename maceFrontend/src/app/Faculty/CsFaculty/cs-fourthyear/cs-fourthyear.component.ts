...
@Component({
  selector: 'app-cs-fourthyear',
  templateUrl: './cs-fourthyear.component.html',
  styleUrls: ['./cs-fourthyear.component.css']
})
export class CsFourthyearComponent {
  ...
  subjectAsubmit(){
    if(this.subjectAarray.valid){
      this.service.csfourthyearsubA(this.Mark_Email,this.subjectAarray.value.subjectAFirst,this.subjectAarray.value.subjectASecond,this.subjectAarray.value.subjectAThird)
      .subscribe((result:any)=>{
        if(result){
  ...
  subjectBsubmit(){
    if(this.subjectBarray.valid){
      this.service.csfourthyearsubB(this.Mark_Email,this.subjectBarray.value.subjectBFirst,this.subjectBarray.value.subjectBSecond,this.subjectBarray.value.subjectBThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectCsubmit(){
    if(this.subjectCarray.valid){
      this.service.csfourthyearsubC(this.Mark_Email,this.subjectCarray.value.subjectCFirst,this.subjectCarray.value.subjectCSecond,this.subjectCarray.value.subjectCThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectDsubmit(){
    if(this.subjectDarray.valid){
      this.service.csfourthyearsubD(this.Mark_Email,this.subjectDarray.value.subjectDFirst,this.subjectDarray.value.subjectDSecond,this.subjectDarray.value.subjectDThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectEsubmit(){
    if(this.subjectEarray.valid){
      this.service.csfourthyearsubE(this.Mark_Email,this.subjectEarray.value.subjectEFirst,this.subjectEarray.value.subjectESecond,this.subjectEarray.value.subjectEThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectFsubmit(){
    if(this.subjectFarray.valid){      
      this.service.csfourthyearsubF(this.Mark_Email,this.subjectFarray.value.subjectFFirst,this.subjectFarray.value.subjectFSecond,this.subjectFarray.value.subjectFThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
