...
@Component({
  selector: 'app-cs-firstyear',
  templateUrl: './cs-firstyear.component.html',
  styleUrls: ['./cs-firstyear.component.css']
})
export class CsFirstyearComponent {
  ...
  subjectAsubmit(){
    if(this.subjectAarray.valid){
      this.service.csfirstyearsubA(this.Mark_Email,this.subjectAarray.value.subjectAFirst,this.subjectAarray.value.subjectASecond,this.subjectAarray.value.subjectAThird)
      .subscribe((result:any)=>{
        if(result){
  ...
  subjectBsubmit(){
    if(this.subjectBarray.valid){
      this.service.csfirstyearsubB(this.Mark_Email,this.subjectBarray.value.subjectBFirst,this.subjectBarray.value.subjectBSecond,this.subjectBarray.value.subjectBThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectCsubmit(){
    if(this.subjectCarray.valid){
      this.service.csfirstyearsubC(this.Mark_Email,this.subjectCarray.value.subjectCFirst,this.subjectCarray.value.subjectCSecond,this.subjectCarray.value.subjectCThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectDsubmit(){
    if(this.subjectDarray.valid){
      this.service.csfirstyearsubD(this.Mark_Email,this.subjectDarray.value.subjectDFirst,this.subjectDarray.value.subjectDSecond,this.subjectDarray.value.subjectDThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectEsubmit(){
    if(this.subjectEarray.valid){
      this.service.csfirstyearsubE(this.Mark_Email,this.subjectEarray.value.subjectEFirst,this.subjectEarray.value.subjectESecond,this.subjectEarray.value.subjectEThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectFsubmit(){
    if(this.subjectFarray.valid){      
      this.service.csfirstyearsubF(this.Mark_Email,this.subjectFarray.value.subjectFFirst,this.subjectFarray.value.subjectFSecond,this.subjectFarray.value.subjectFThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
