...
@Component({
  selector: 'app-civil-secondyear',
  templateUrl: './civil-secondyear.component.html',
  styleUrls: ['./civil-secondyear.component.css']
})
export class CivilSecondyearComponent {
  ...
  subjectAsubmit(){
    if(this.subjectAarray.valid){
      this.service.civilsecondyearsubA(this.Mark_Email,this.subjectAarray.value.subjectAFirst,this.subjectAarray.value.subjectASecond,this.subjectAarray.value.subjectAThird)
      .subscribe((result:any)=>{
        if(result){
  ...
  subjectBsubmit(){
    if(this.subjectBarray.valid){
      this.service.civilsecondyearsubB(this.Mark_Email,this.subjectBarray.value.subjectBFirst,this.subjectBarray.value.subjectBSecond,this.subjectBarray.value.subjectBThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectCsubmit(){
    if(this.subjectCarray.valid){
      this.service.civilsecondyearsubC(this.Mark_Email,this.subjectCarray.value.subjectCFirst,this.subjectCarray.value.subjectCSecond,this.subjectCarray.value.subjectCThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectDsubmit(){
    if(this.subjectDarray.valid){
      this.service.civilsecondyearsubD(this.Mark_Email,this.subjectDarray.value.subjectDFirst,this.subjectDarray.value.subjectDSecond,this.subjectDarray.value.subjectDThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectEsubmit(){
    if(this.subjectEarray.valid){
      this.service.civilsecondyearsubE(this.Mark_Email,this.subjectEarray.value.subjectEFirst,this.subjectEarray.value.subjectESecond,this.subjectEarray.value.subjectEThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
  ...
  subjectFsubmit(){
    if(this.subjectFarray.valid){      
      this.service.civilsecondyearsubF(this.Mark_Email,this.subjectFarray.value.subjectFFirst,this.subjectFarray.value.subjectFSecond,this.subjectFarray.value.subjectFThird)
      .subscribe((result:any)=>{
        if(result){
          alert(result.message)
          location.reload()
